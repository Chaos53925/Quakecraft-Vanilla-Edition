...
execute as @s[tag=!game,tag=hat0] unless entity @s[nbt={Inventory:[{Slot:10b, id:"minecraft:barrier"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt.
execute as @s[tag=!game,tag=!hat0] unless entity @s[nbt={Inventory:[{Slot:10b, id:"minecraft:barrier"}]}] run function custom:shop/buttons/hat/hat0/inactive
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat1,tag=hat1b] unless entity @s[nbt={Inventory:[{Slot:11b, id:"minecraft:glass"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat1,tag=hat1b] unless entity @s[nbt={Inventory:[{Slot:11b, id:"minecraft:glass"}]}] run function custom:shop/buttons/hat/hat1/inactive
#pbuttons kaufen.
...
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat4,tag=hat4b] unless entity @s[nbt={Inventory:[{Slot:12b, id:"minecraft:redstone_block"}]}] run function custom:shop/buttons/hat/hat4/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat9,tag=hat9b] unless entity @s[nbt={Inventory:[{Slot:13b, id:"minecraft:target"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat9,tag=hat9b] unless entity @s[nbt={Inventory:[{Slot:13b, id:"minecraft:target"}]}] run function custom:shop/buttons/hat/hat9/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat10,tag=hat10b] unless entity @s[nbt={Inventory:[{Slot:14b, id:"minecraft:tnt"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat10,tag=hat10b] unless entity @s[nbt={Inventory:[{Slot:14b, id:"minecraft:tnt"}]}] run function custom:shop/buttons/hat/hat10/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat11,tag=hat11b] unless entity @s[nbt={Inventory:[{Slot:15b, id:"minecraft:slime_block"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat11,tag=hat11b] unless entity @s[nbt={Inventory:[{Slot:15b, id:"minecraft:slime_block"}]}] run function custom:shop/buttons/hat/hat11/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat12,tag=hat12b] unless entity @s[nbt={Inventory:[{Slot:16b, id:"minecraft:observer"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat12,tag=hat12b] unless entity @s[nbt={Inventory:[{Slot:16b, id:"minecraft:observer"}]}] run function custom:shop/buttons/hat/hat12/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat2,tag=hat2b] unless entity @s[nbt={Inventory:[{Slot:19b, id:"minecraft:creeper_head"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat2,tag=hat2b] unless entity @s[nbt={Inventory:[{Slot:19b, id:"minecraft:creeper_head"}]}] run function custom:shop/buttons/hat/hat2/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat6,tag=hat6b] unless entity @s[nbt={Inventory:[{Slot:20b, id:"minecraft:skeleton_skull"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat6,tag=hat6b] unless entity @s[nbt={Inventory:[{Slot:20b, id:"minecraft:skeleton_skull"}]}] run function custom:shop/buttons/hat/hat6/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat5,tag=hat5b] unless entity @s[nbt={Inventory:[{Slot:21b, id:"minecraft:wither_skeleton_skull"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat5,tag=hat5b] unless entity @s[nbt={Inventory:[{Slot:21b, id:"minecraft:wither_skeleton_skull"}]}] run function custom:shop/buttons/hat/hat5/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat3,tag=hat3b] unless entity @s[nbt={Inventory:[{Slot:22b, id:"minecraft:dragon_head"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat3,tag=hat3b] unless entity @s[nbt={Inventory:[{Slot:22b, id:"minecraft:dragon_head"}]}] run function custom:shop/buttons/hat/hat3/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat8,tag=hat8b] unless entity @s[nbt={Inventory:[{Slot:28b, id:"minecraft:end_rod"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat8,tag=hat8b] unless entity @s[nbt={Inventory:[{Slot:28b, id:"minecraft:end_rod"}]}] run function custom:shop/buttons/hat/hat8/inactive
#pbuttons kaufen.
...
#pbuttons 2
#pbuttons bereits ausgewählt
execute as @s[tag=!game,tag=hat7,tag=hat7b] unless entity @s[nbt={Inventory:[{Slot:29b, id:"minecraft:lightning_rod"}]}] run function custom:shop/buttons/hat/active
#pbuttons nicht ausgewählt aber gekauft
execute as @s[tag=!game,tag=!hat7,tag=hat7b] unless entity @s[nbt={Inventory:[{Slot:29b, id:"minecraft:lightning_rod"}]}] run function custom:shop/buttons/hat/hat7/inactive
#pbuttons kaufen.
