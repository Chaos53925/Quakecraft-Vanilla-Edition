...
execute as @a[team=desert] run function custom:maps/rewards
...
function custom:maps/desert/place/2
scoreboard players operation #temp desertplace = @p[tag=d1] DesertKills
function custom:maps/desert/place/3
scoreboard players operation #temp desertplace = @p[tag=d1] DesertKills
function custom:maps/desert/place/4
scoreboard players operation #temp desertplace = @p[tag=d1] DesertKills
function custom:maps/desert/place/5
scoreboard players operation #temp desertplace = @p[tag=d1] DesertKills
function custom:maps/desert/place/6
scoreboard players operation #temp desertplace = @p[tag=d1] DesertKills
function custom:maps/desert/place/7
scoreboard players operation #temp desertplace = @p[tag=d1] DesertKills
function custom:maps/desert/place/8
scoreboard players operation #temp desertplace = @p[tag=d1] DesertKills
function custom:maps/desert/place/9
scoreboard players operation #temp desertplace = @p[tag=d1] DesertKills
function custom:maps/desert/place/10
