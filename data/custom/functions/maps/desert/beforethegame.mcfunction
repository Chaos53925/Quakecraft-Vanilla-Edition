...
execute as @a[team=desert] run function custom:maps/invbefore

execute if score #desert desertlobby matches 1.. run function custom:maps/desert/timer
...
execute if score #desertsek game matches 0..59 if score #desertmin game matches 1..2 if score #desertquick game matches 0 if score #desert desertlobby matches 2.. if score #desert desertlobby = #desert desertvote run function custom:maps/desert/quickstart
execute if score #desertsek game matches 16..59 if score #desertmin game matches 0 if score #desertquick game matches 0 if score #desert desertlobby matches 2.. if score #desert desertlobby = #desert desertvote run function custom:maps/desert/quickstart

execute as @a[team=desert,tag=!desertvote,scores={book=1..}] unless entity @s[nbt={Inventory:[{Slot:7b, id:"minecraft:knowledge_book"}]}] run function custom:maps/desert/voting
