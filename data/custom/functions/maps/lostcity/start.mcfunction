...
execute as @a[team=lostcity] run function custom:maps/abilities
execute as @a[team=lostcity] run function custom:maps/inv
execute as @a[team=lostcity] run function custom:maps/scores
