...
execute as @a[team=candy] run function custom:maps/invbefore

execute if score #candy candylobby matches 1.. run function custom:maps/candy/timer
...
execute if score #candysek game matches 0..59 if score #candymin game matches 1..2 if score #candyquick game matches 0 if score #candy candylobby matches 2.. if score #candy candylobby = #candy candyvote run function custom:maps/candy/quickstart
execute if score #candysek game matches 16..59 if score #candymin game matches 0 if score #candyquick game matches 0 if score #candy candylobby matches 2.. if score #candy candylobby = #candy candyvote run function custom:maps/candy/quickstart

execute as @a[team=candy,tag=!candyvote,scores={book=1..}] unless entity @s[nbt={Inventory:[{Slot:7b, id:"minecraft:knowledge_book"}]}] run function custom:maps/candy/voting
