...
execute as @a[team=candy] run function custom:maps/invgame

execute if entity @p[team=candy,scores={CandyKills=30..}] run function custom:maps/candy/winner

scoreboard players set #candy candylobby 0
execute as @a[team=candy] run scoreboard players add #candy candylobby 1
execute if score #candy candylobby matches ..1 run function custom:maps/candy/cancel
...
#respawn functions
function custom:maps/candy/spawn

execute as @a[team=candy] run function custom:reload/reload

#endfunktion
execute at @p[tag=c1,team=candy] run function custom:maps/candy/end