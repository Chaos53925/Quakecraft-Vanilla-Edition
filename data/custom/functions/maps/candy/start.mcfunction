...
execute as @a[team=candy] run function custom:maps/abilities
execute as @a[team=candy] run function custom:maps/inv
execute as @a[team=candy] run function custom:maps/scores
