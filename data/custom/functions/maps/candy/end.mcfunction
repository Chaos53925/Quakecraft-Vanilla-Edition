...
execute as @a[team=candy] run function custom:maps/rewards
...
function custom:maps/candy/place/2
scoreboard players operation #temp candyplace = @p[tag=c1] CandyKills
function custom:maps/candy/place/3
scoreboard players operation #temp candyplace = @p[tag=c1] CandyKills
function custom:maps/candy/place/4
scoreboard players operation #temp candyplace = @p[tag=c1] CandyKills
function custom:maps/candy/place/5
scoreboard players operation #temp candyplace = @p[tag=c1] CandyKills
function custom:maps/candy/place/6
scoreboard players operation #temp candyplace = @p[tag=c1] CandyKills
function custom:maps/candy/place/7
scoreboard players operation #temp candyplace = @p[tag=c1] CandyKills
function custom:maps/candy/place/8
scoreboard players operation #temp candyplace = @p[tag=c1] CandyKills
function custom:maps/candy/place/9
scoreboard players operation #temp candyplace = @p[tag=c1] CandyKills
function custom:maps/candy/place/10
