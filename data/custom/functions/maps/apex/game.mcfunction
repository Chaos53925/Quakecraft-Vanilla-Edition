...
execute as @a[team=apex] run function custom:maps/invgame

execute if entity @p[team=apex,scores={ApexKills=30..}] run function custom:maps/apex/winner

scoreboard players set #apex apexlobby 0
execute as @a[team=apex] run scoreboard players add #apex apexlobby 1
execute if score #apex apexlobby matches ..1 run function custom:maps/apex/cancel
#effekte in-game
...
execute as @a[team=apex] run function custom:reload/reload

#endfunktion
execute at @p[tag=a1,team=apex] run function custom:maps/apex/end
