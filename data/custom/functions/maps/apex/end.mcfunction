...
execute as @a[team=apex] run function custom:maps/rewards
...
function custom:maps/apex/place/2
scoreboard players operation #temp apexplace = @p[tag=a1] ApexKills
function custom:maps/apex/place/3
scoreboard players operation #temp apexplace = @p[tag=a1] ApexKills
function custom:maps/apex/place/4
scoreboard players operation #temp apexplace = @p[tag=a1] ApexKills
function custom:maps/apex/place/5
scoreboard players operation #temp apexplace = @p[tag=a1] ApexKills
function custom:maps/apex/place/6
scoreboard players operation #temp apexplace = @p[tag=a1] ApexKills
function custom:maps/apex/place/7
scoreboard players operation #temp apexplace = @p[tag=a1] ApexKills
function custom:maps/apex/place/8
scoreboard players operation #temp apexplace = @p[tag=a1] ApexKills
function custom:maps/apex/place/9
scoreboard players operation #temp apexplace = @p[tag=a1] ApexKills
function custom:maps/apex/place/10
