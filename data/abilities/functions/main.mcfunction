...
execute as @a[team=!Lobby,tag=ar2,tag=play,scores={effectsek=..0,book=1..}] unless entity @s[nbt={Inventory:[{Slot:1b, id:"minecraft:knowledge_book"}]}] at @s run function abilities:immune
execute as @a[team=!Lobby,tag=ar3,tag=play,scores={effectsek=..0,book=1..}] unless entity @s[nbt={Inventory:[{Slot:1b, id:"minecraft:knowledge_book"}]}] at @s run function abilities:tp
execute as @a[team=!Lobby,tag=ar4,tag=play,scores={effectsek=..0,book=1..}] unless entity @s[nbt={Inventory:[{Slot:1b, id:"minecraft:knowledge_book"}]}] at @s run function abilities:reload
execute as @a[team=!Lobby,tag=ar5,tag=play,scores={effectsek=..0,book=1..}] unless entity @s[nbt={Inventory:[{Slot:1b, id:"minecraft:knowledge_book"}]}] at @s run function abilities:speed
execute as @a[team=!Lobby,tag=ar6,tag=play,scores={effectsek=..0,book=1..}] unless entity @s[nbt={Inventory:[{Slot:1b, id:"minecraft:knowledge_book"}]}] at @s run function abilities:invisibility
