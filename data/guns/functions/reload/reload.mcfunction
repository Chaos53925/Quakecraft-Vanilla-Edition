...
title @s actionbar [{"translate":"game.guns.reload","color":"gold","with":[{"text":"«","color":"red"},{"text":"»","color":"red"},{"text":"|","color":"red"},{"score":{"name":"@s","objective":"ammo"},"color":"gold"},{"score":{"name":"@s","objective":"gunrlsek"},"color":"red"},{"score":{"name":"@s","objective":"gunrlmsek"},"color":"red"},{"score":{"name":"@s","objective":"kstreak"},"color":"red"},{"score":{"name":"@s","objective":"effectsek"},"color":"red"},{"score":{"name":"@s","objective":"Coin"},"color":"red"}]}]
