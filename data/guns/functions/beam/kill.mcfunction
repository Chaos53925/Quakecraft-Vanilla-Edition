tellraw @s[scores={da=30..49}] [{"text":"Snipeshot: ","color":"aqua"},{"score":{"name":"@s","objective":"da"},"color":"green"},{"text":",","color":"green"},{"score":{"name":"@s","objective":"dd"},"color":"green"},{"text":"m","color":"green"}]
tellraw @s[scores={da=50..}] [{"text":"Super-Snipeshot: ","color":"dark_purple"},{"score":{"name":"@s","objective":"da"},"color":"green"},{"text":",","color":"green"},{"score":{"name":"@s","objective":"dd"},"color":"green"},{"text":"m","color":"green"}]
