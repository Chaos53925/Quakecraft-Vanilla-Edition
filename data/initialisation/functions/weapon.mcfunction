...
scoreboard objectives add kstreak dummy
scoreboard objectives add dkills dummy
scoreboard objectives add tkills dummy
scoreboard objectives add mkills dummy
scoreboard objectives add gkills dummy
scoreboard objectives add ks10 dummy
scoreboard objectives add ks20 dummy
scoreboard objectives add ks30 dummy
scoreboard objectives add ks38 dummy
#tode
scoreboard objectives add Tode deathCount {"text":"Tode"}
#join trigger
scoreboard objectives add apexjoin trigger
scoreboard objectives add desertjoin trigger
scoreboard objectives add candyjoin trigger
scoreboard objectives add lostcityjoin trigger
scoreboard objectives add netherjoin trigger
scoreboard objectives add endjoin trigger
...
scoreboard players set MAX railgun 500
scoreboard players set PARTICLES railgun 2

scoreboard objectives add Wins dummy
scoreboard objectives add lost dummy
...
scoreboard players set #nethergame game 0
