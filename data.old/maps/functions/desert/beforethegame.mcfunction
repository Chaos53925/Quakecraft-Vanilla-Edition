...
execute unless score #reload reload matches 0 unless score #desertsek game matches 0..9 run title @a[team=desert] actionbar [{"translate":"map.before.actionbar","color":"yellow","with":[{"score":{"name":"#desert","objective":"desertlobby"},"color":"aqua"},{"score":{"name":"#desertmin","objective":"game"},"color":"aqua"},{"score":{"name":"#desertsek","objective":"game"},"color":"aqua"},{"score":{"name":"#desert","objective":"desertvote"},"color":"aqua"},{"text":"10","color":"aqua"},{"text":">>>","color":"gold"},{"text":"|","color":"gold"},{"text":"<<<","color":"gold"},{"text":"","color":"aqua"}]}]
execute unless score #reload reload matches 0 if score #desertsek game matches 0..9 run title @a[team=desert] actionbar [{"translate":"map.before.actionbar","color":"yellow","with":[{"score":{"name":"#desert","objective":"desertlobby"},"color":"aqua"},{"score":{"name":"#desertmin","objective":"game"},"color":"aqua"},{"score":{"name":"#desertsek","objective":"game"},"color":"aqua"},{"score":{"name":"#desert","objective":"desertvote"},"color":"aqua"},{"text":"10","color":"aqua"},{"text":">>>","color":"gold"},{"text":"|","color":"gold"},{"text":"<<<","color":"gold"},{"text":"0","color":"aqua"}]}]
