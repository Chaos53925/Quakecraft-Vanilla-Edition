...
execute unless entity @p[team=desert,tag=d3] as @a[team=desert,tag=!d1,tag=!d2] if score @s DesertKills = #temp desertplace run tag @s add d3
...
execute if score #temp desertplace matches 0.. run function maps:desert/place/3