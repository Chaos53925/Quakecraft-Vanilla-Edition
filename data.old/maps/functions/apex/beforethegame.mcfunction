...
execute if score #apex apexlobby matches 1.. run function maps:apex/timer

execute as @a[team=apex] run function maps:invbefore
...
execute if score #apexsek game matches 0..59 if score #apexmin game matches 1..2 if score #apexquick game matches 0 if score #apex apexlobby matches 2.. if score #apex apexlobby = #apex apexvote run function maps:apex/quickstart
execute if score #apexsek game matches 16..59 if score #apexmin game matches 0 if score #apexquick game matches 0 if score #apex apexlobby matches 2.. if score #apex apexlobby = #apex apexvote run function maps:apex/quickstart

execute as @a[team=apex,tag=!apexvote,scores={book=1..}] unless entity @s[nbt={Inventory:[{Slot:7b, id:"minecraft:knowledge_book"}]}] run function maps:apex/voting
...
execute unless score #reload reload matches 0 unless score #apexsek game matches 0..9 run title @a[team=apex] actionbar [{"translate":"map.before.actionbar","color":"yellow","with":[{"score":{"name":"#apex","objective":"apexlobby"},"color":"aqua"},{"score":{"name":"#apexmin","objective":"game"},"color":"aqua"},{"score":{"name":"#apexsek","objective":"game"},"color":"aqua"},{"score":{"name":"#apex","objective":"apexvote"},"color":"aqua"},{"text":"10","color":"aqua"},{"text":">>>","color":"gold"},{"text":"|","color":"gold"},{"text":"<<<","color":"gold"},{"text":"","color":"aqua"}]}]
execute unless score #reload reload matches 0 if score #apexsek game matches 0..9 run title @a[team=apex] actionbar [{"translate":"map.before.actionbar","color":"yellow","with":[{"score":{"name":"#apex","objective":"apexlobby"},"color":"aqua"},{"score":{"name":"#apexmin","objective":"game"},"color":"aqua"},{"score":{"name":"#apexsek","objective":"game"},"color":"aqua"},{"score":{"name":"#apex","objective":"apexvote"},"color":"aqua"},{"text":"10","color":"aqua"},{"text":">>>","color":"gold"},{"text":"|","color":"gold"},{"text":"<<<","color":"gold"},{"text":"0","color":"aqua"}]}]
