...
scoreboard players set @s gunrlmsek 0
scoreboard players set @s gunrlsek 0
scoreboard players set @s[tag=!slv1,tag=!slv2,tag=!slv3,tag=!slv4,tag=!slv5,tag=!slv6] ammo 1
scoreboard players set @s[tag=!wlv1,tag=!wlv2,tag=!wlv3,tag=!wlv4,tag=!wlv5,tag=!wlv6,tag=!wlv7] ammo 2
