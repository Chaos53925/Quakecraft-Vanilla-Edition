...
execute unless score #reload reload matches 0 unless score #candysek game matches 0..9 run title @a[team=candy] actionbar [{"translate":"map.before.actionbar","color":"yellow","with":[{"score":{"name":"#candy","objective":"candylobby"},"color":"aqua"},{"score":{"name":"#candymin","objective":"game"},"color":"aqua"},{"score":{"name":"#candysek","objective":"game"},"color":"aqua"},{"score":{"name":"#candy","objective":"candyvote"},"color":"aqua"},{"text":"10","color":"aqua"},{"text":">>>","color":"gold"},{"text":"|","color":"gold"},{"text":"<<<","color":"gold"},{"text":"","color":"aqua"}]}]
execute unless score #reload reload matches 0 if score #candysek game matches 0..9 run title @a[team=candy] actionbar [{"translate":"map.before.actionbar","color":"yellow","with":[{"score":{"name":"#candy","objective":"candylobby"},"color":"aqua"},{"score":{"name":"#candymin","objective":"game"},"color":"aqua"},{"score":{"name":"#candysek","objective":"game"},"color":"aqua"},{"score":{"name":"#candy","objective":"candyvote"},"color":"aqua"},{"text":"10","color":"aqua"},{"text":">>>","color":"gold"},{"text":"|","color":"gold"},{"text":"<<<","color":"gold"},{"text":"0","color":"aqua"}]}]
